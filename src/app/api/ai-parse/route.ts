...
2. דיוק בשם המדווח:
   - אם קיים reporter_name או reporter_email בנתוני הטופס הקיימים (currentFormData), שמור עליהם בדיוק כפי שהם, ואל תשרשר או תשכפל טקסט.
   - אל תיצור שמות כמו "דניאל אורן | דניאל אורן". השתמש בשם נקי בלבד.
...
4. אם חסר פרט קריטי להבנת מהות התקלה, שאל שאלת המשך קצרה ב-follow_up_question. אם יש מספיק מידע, החזר follow_up_question: null.
`;
